...
<div id="header" class="wrap">
	...
	<div class="help"><a href="#" class="shopping">购物车</a><a href="login.jsp">登录</a><a href="register.jsp">注册</a><a href="MessageServlet?op=toMessage&currPage=1&pageSize=3">留言</a></div>
	<div class="navbar">
		<ul class="clearfix">

...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>修改个人信息</h1>
			<form id="regForm" method="post" action="useLogin" onsubmit="return checkForm(this);">
				<input type="hidden" name="op" value="reg">
				<table>
					<tr>
						<td class="field">修改用户名：</td>
					...
					<tr>
						<td class="field">修改联系方式：</td>
						<td><input class="text" type="text" name="retel" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
						<td class="field">修改邮箱：</td>
						<td><input class="text" type="text" name="reemail" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
						<td class="field">修改头像：</td>
						<td><input class="text" type="file" name="reemail" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><span></span></td>
					</tr>
					<tr>
						<td></td>
